...
{
    /// <summary>
    /// Comes from LemmyNanny to display on site
    /// </summary>
    public class HostWebhookController : Controller
    {
        ...
        public HostWebhookController(IHubContext<ProcessedHub> processedHub, IConfiguration config, IMemoryCache memoryCache)
        {
